...
void begin_frame(const Store& store) {
    {
        ...
        auto camera_target = store.get<glm::vec3>(StoreParams::kCameraTarget);
        ...
        glLoadIdentity();
        gluPerspective(glm::degrees(store.get<f32>(StoreParams::kCameraFov)),
